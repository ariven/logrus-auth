	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container">
				...
				<?php
					if ((isset($menu['member'])) and (count($menu['member']) > 0))
					{
						?>
						<ul class="nav pull-right">
						<li class="dropdown">

							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $member_name; ?> <b class="caret"></b></a>

							<ul class="dropdown-menu">
								<?php echo $menu['member']; ?>
							</ul>
						</li>
							</ul>
						<?php
